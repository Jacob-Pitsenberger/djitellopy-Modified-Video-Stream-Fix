...
class Tello:
    ...
    def query_distance_tof(self) -> float:
        ...
        # wrapped tof[:-2] in float conversion to fix error: File "C:\Python\lib\site-packages\djitellopy\tello.py",
        # line 972, in query_distance_tof
        # return int(tof[:-2]) / 10
        # ValueError: invalid literal for int() with base 10:
        return int(float(tof[:-2])) / 10
